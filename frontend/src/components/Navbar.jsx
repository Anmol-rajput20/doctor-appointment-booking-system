        ...
        <div className='flex item-center gap-4'>
          {
            ...
            ? <div className='flex items-center gap-2 cursor-pointer group relative'>
              <img className='w-10 rounded-full' src={assets.profile_pic} alt=""></img>
              <img className='w-2.5' src={assets.dropdown_icon}></img>
              <div className='absolute top-0 right-0 pt-14 text-base font-medium text-gray-600 z-index hidden group-hover:block'>
                <div className='min-w-48 bg-stone-100 rounded flex flex-col gap-4 p-4 m-2'>
                  <p onClick={() => navigate('/my-profile')} className='hover:text-black cursor-pointer'>My Profile</p>
                  <p onClick={() => navigate('/appointment')} className='hover:text-black cursor-pointer'>My Appointments</p>
